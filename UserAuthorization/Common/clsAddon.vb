...
Namespace UserAuthorization
    Public Class clsAddon
        ...
        Public objBOMPF As ClsBOM_ProcessForce
        Public objManOrderPF As ClsManfactOrder_ProcessForce
        Public objBOMList As ClsBOMList
        Public objMIPLQC As ClsMIPLQC
        Public objlistfromQC As ClsListFromQC
        ...
        Private Sub Create_Objects()
            ...
            objBOMPF = New ClsBOM_ProcessForce
            objManOrderPF = New ClsManfactOrder_ProcessForce
            objBOMList = New ClsBOMList
            objMIPLQC = New ClsMIPLQC
            objlistfromQC = New ClsListFromQC
        End Sub
...
#Region "Menu Creation Details"
        ...
        Private Sub Menu()
            ...
            If objapplication.Menus.Item("43520").SubMenus.Exists("USRCFG") Then Return
            Menucount = objapplication.Menus.Item("8448").SubMenus.Count ' Under Administration module setup->General
            'CreateMenu("", Menucount, "Check Print", SAPbouiCOM.BoMenuType.mt_POPUP, "CHKPRT", "43520")
            CreateMenu("", Menucount, "User Auth Config", SAPbouiCOM.BoMenuType.mt_STRING, "USRCFG", "8448") : Menucount += 1 ' "43537"
            ...
            Try
                ...
                Select Case pVal.FormTypeEx
                    Case "CT_PF_ManufacOrd"
                        objManOrderPF.ItemEvent(FormUID, pVal, BubbleEvent)
                    Case "CT_PF_OBOMCode"
                        objBOMPF.ItemEvent(FormUID, pVal, BubbleEvent)
                    Case "9999"
                        objBOMList.ItemEvent(FormUID, pVal, BubbleEvent)
                    Case "MIPLQC"
                        objMIPLQC.ItemEvent(FormUID, pVal, BubbleEvent)
                    Case "OCFL"
                        objlistfromQC.ItemEvent(FormUID, pVal, BubbleEvent)
                End Select
            Catch ex As Exception
...
#Region "Form Data event"
        Private Sub objApplication_FormDataEvent(ByRef pVal As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean) Handles objapplication.FormDataEvent
            Try
                ...
                Select Case pVal.FormTypeEx
                    Case "CT_PF_ManufacOrd"
                        objManOrderPF.FormDataEvent(pVal, BubbleEvent)
                    Case "CT_PF_OBOMCode"
                        objBOMPF.FormDataEvent(pVal, BubbleEvent)
                    Case "MIPLQC"
                        objMIPLQC.FormDataEvent(pVal, BubbleEvent)
                End Select
                'End If
        ...
        Public Sub SBO_Application_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles objapplication.MenuEvent
            Try
                Select Case pVal.MenuUID
                    Case "1281", "1282", "1283", "1284", "1285", "1286", "1287", "1300", "1288", "1289", "1290", "1291", "1304", "1292", "1293", "CPYD", "6005", "6913"
        ...
        Public Sub MenuEvent_For_FormOpening(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
            Try
                If pVal.BeforeAction = False Then
                    Select Case pVal.MenuUID
                        Case "USRCFG"
                            Dim activeform As New FrmUserConfig
                            activeform.Show()
