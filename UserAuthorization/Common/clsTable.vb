...
#Region "Master Data Creation"
        ...
        Private Sub User_Auth_Config_Master()

            AddTables("AT_USRCFG", "User Auth Config Header", SAPbobsCOM.BoUTBTableType.bott_MasterData)
            AddTables("AT_USRCFG1", "User Auth Config Details 1", SAPbobsCOM.BoUTBTableType.bott_MasterDataLines)
            AddTables("AT_USRCFG2", "User Auth Config Details 2", SAPbobsCOM.BoUTBTableType.bott_MasterDataLines)

            AddFields("@AT_USRCFG", "Dept", "Department", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG", "CreateBy", "Created BY", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG", "UpdateBy", "Updated BY", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG", "CreateOn", "Created ON", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG", "UpdateOn", "Updated ON", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG", "Remark", "Remarks", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
            AddFields("@AT_USRCFG", "UserId", "User Id", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)

            AddFields("@AT_USRCFG1", "GrpCode", "Group Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG1", "GrpName", "Group Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
            AddFields("@AT_USRCFG1", "Assign", "Assign", SAPbobsCOM.BoFieldTypes.db_Alpha, 3, , , "N", , {"Y,Yes", "N,No"})

            AddFields("@AT_USRCFG2", "WhsCode", "Warehouse Code", SAPbobsCOM.BoFieldTypes.db_Alpha, 30)
            AddFields("@AT_USRCFG2", "WhsName", "Warehouse Name", SAPbobsCOM.BoFieldTypes.db_Alpha, 100)
            AddFields("@AT_USRCFG2", "Assign", "Assign", SAPbobsCOM.BoFieldTypes.db_Alpha, 3, , , "N", , {"Y,Yes", "N,No"})

            AddUDO("USERCFG", "User Auth Config", SAPbobsCOM.BoUDOObjType.boud_MasterData, "AT_USRCFG", {"AT_USRCFG1", "AT_USRCFG2"}, {"Code", "Name"}, True, False)
        End Sub
